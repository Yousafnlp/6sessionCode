...
export default function Contact() {
  ...
  return (
    <section className="relative bg-navy min-h-screen py-20 overflow-hidden" id="register">
      <div className="container relative mx-auto px-4 z-10">
        ...
        >
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 bg-navy-50/30 backdrop-blur-sm p-6 rounded-lg border border-gold/20">
              <FormField control={form.control} name="name" render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-white">Full Name</FormLabel>
                  <FormControl>
                    <Input placeholder="Enter your full name" className="bg-navy-50/50 border-gold/20 text-white placeholder:text-gray-500" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <FormField control={form.control} name="email" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter your email" type="email" className="bg-navy-50/50 border-gold/20 text-white placeholder:text-gray-500" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <FormField control={form.control} name="contact" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter your phone number" className="bg-navy-50/50 border-gold/20 text-white placeholder:text-gray-500" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <FormField control={form.control} name="dob" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter your date of birth" className="bg-navy-50/50 border-gold/20 text-white placeholder:text-gray-500" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
