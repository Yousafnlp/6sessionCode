...
export default function CoachingSessionCard({ number, title, description }: CoachingSessionCardProps) {
  return (
    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
      <Card className="bg-navy-50/30 backdrop-blur-sm border-gold/60  shadow-md hover:border-gold transition-colors duration-300 overflow-hidden relative group">
