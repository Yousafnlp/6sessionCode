...
export default function About() {
  return (
    <section className="relative bg-navy py-20 overflow-hidden min-h-screen">
      {/* Background gradient effects */}
      <div className="absolute inset-0 bg-gradient-to-b from-navy-50/50 via-transparent to-navy-50/50" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(197,179,81,0.1),transparent_50%)]" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative md:h-[600px] h-[480px] w-full max-w-md mx-auto">
              ...
              <div className="absolute inset-0 rounded-lg overflow-hidden transform hover:scale-[1.02] transition-transform duration-500">
                ...
                />
                {/* Gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-navy/50 via-transparent to-transparent z-10" />
              </div>
            </div>
            ...
            <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 w-full max-w-md">
              ...
              >
                ...
                <Link
                  ...
                  target="_blank"
                  className="group bg-navy-50/80 backdrop-blur-lg p-4 rounded-lg border border-red-500 transition-colors hover:border-gold/40"
                >
          ...
          >
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-3xl md:text-4xl mt-10 lg:mt-0 font-bold bg-gradient-to-r from-gold-light via-gold to-gold-dark bg-clip-text text-transparent"
            >
              Meet Your Mentor
            </motion.h2>
            ...
            <Button
              asChild
              className="bg-gold hover:bg-gold-light text-navy font-semibold px-5 py-4 text-lg gap-0 transform  animate-scale-loop"
            >
              <Link href="/#register">
                Register Now
